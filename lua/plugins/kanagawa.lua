...
function M.config()
    ...
    vim.api.nvim_set_hl(0, 'FloatBorder', { bg = nil, fg = colors.palette.oniViolet, bold = true })
    vim.api.nvim_set_hl(0, 'NormalFloat', { bg = nil, fg = colors.palette.fujiWhite, bold = false })
end
